...
%           [2] Ferdinand Schockenhoff, "Fahrzeugkonzeptentwicklung für autonome, geteilte und elektrische Mobilität", Technical University of Munich, Institute of Automotive Technology, 2022         
% ------------
% Input:    - vehicle
% ------------
...
switch v.Error
    ...
    case 98
        Msg='Required tire volume too large! Consider decreasing the mass of the VC or increasing the wheel diameter.';
    case 99
        try
            Msg=v.Error_Detail;
        catch
