...
% Changed by: Ferdinand Schockenhoff (FTM, Technical University of Munich), Marc Raudszus (Technical University of Munich)
%-------------
...
% ------------
% Sources:   Adrian König, "Methodik zur Auslegung von autonomen Fahrzeugkonzepten", Technical University of Munich, Institute of Automotive Technology, 2022
%            Ferdinand Schockenhoff, "Fahrzeugkonzeptentwicklung für autonome, geteilte und elektrische Mobilität", Technical University of Munich, Institute of Automotive Technology, 2022
% ------------
...
%% 0) Software Eco-Drive
Parameters.software.values.power.eco_driving = app.input_eco_driving_percentage.Value;
Parameters.software.check.power.eco_driving = app.input_eco_driving_check.Value;
%% 1) Seating layout
Parameters.input.n_seat_rows = app.input_int_n_rows.Value;
...
switch app.input_seating_layout.Value 
    ...
    case 'Conventional'
        if Parameters.input.n_seat_rows == 2
            ...
            Parameters.input.n_seat_rows=2;
        elseif Parameters.input.n_seat_rows == 3
            Parameters.input.seating_layout = 'con';
            Parameters.input.int_3rows_type = '3con';
            Parameters.input.int_3rows = 1;
            Parameters.input.n_seat_rows=2;
        end
    case 'Vis-à-Vis in front'
        Parameters.input.seating_layout = 'vav';
        Parameters.input.int_3rows_type = '3vavcon';
        Parameters.input.int_3rows = 1;
        Parameters.input.n_seat_rows=2;
    case 'Vis-à-Vis in back'
        Parameters.input.seating_layout = 'con';
        Parameters.input.int_3rows_type = '3convav';
        Parameters.input.int_3rows = 1;
        Parameters.input.n_seat_rows=2;
end
