...
if strcmp(int_type,'btb') % for back-to back config --> no second level 2 --> set Z to zero to ignore further calculation
    CZ_batt_second_level_2=0;
end
...
if strcmp(int_type,'btb') || strcmp(int_type,'sr') % Back-to-Back and Single row --> no second level 2
