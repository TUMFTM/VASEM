...
%           [4] Ferdinand Schockenhoff, "Fahrzeugkonzeptentwicklung für autonome, geteilte und elektrische Mobilität", Technical University of Munich, Institute of Automotive Technology, 2022
% ------------
...
% Edit by: Ferdinand Schockenhoff & Marc Raudszus: 02.06.2022-------------------
[tire_diameter,tire_volume,tire_width,side_wall,error] =calc_tire_width(Tires,rim_diameter,tire_volume,tire_diameter_should,v.Input.tire_type,v.Error);
% Edit by: Ferdinand Schockenhoff & Marc Raudszus: 02.06.2022-------------------
...
function [diameter_final,volume_final,width,sidewall,error] =calc_tire_width(Tires,rim_diameter_in_inches,volume_min,tire_diameter_in_mm,tire_type,error)
%% Description:
...
while check==0
    ...
    if deviation>50
        ...
        error=11;
        position = 1;
        Tires_filt.calculated_diameter_in_mm(1)=625;
        Tires_filt.tire_volume_calculated_in_mm3(1)=4.0e+07;
        Tires_filt.width_in_mm(1)=205;
        Tires_filt.aspect_ratio(1)=60;
        break
        % Edit by: Ferdinand Schockenhoff & Marc Raudszus: 02.06.2022-------------------
    end         
end
