...
% Edited by Ferdinand Schockenhoff (FTM, Technical University of Munich)
%-------------
% Created on: 01.05.2021
% Edited on: 14.06.2022
% ------------
% Version: Matlab2020b
%-------------
...
%           [3] Ferdinand Schockenhoff, "Fahrzeugkonzeptentwicklung für autonome, geteilte und elektrische Mobilität", Technical University of Munich, Institute of Automotive Technology, 2022
% ------------
...
while vehicle.iteration < Parameters.settings.max_iteration
    ...
    %---------edited by Ferdinand Schockenhoff----------%
    % Impact of Eco-Dring Savings
    if Parameters.software.check.power.eco_driving == 1 %Reduce E_bat_sum with eco_driving
        vehicle.LDS.sim_cons.E_bat_sum  = vehicle.LDS.sim_cons.E_bat_sum*((100-Parameters.software.values.power.eco_driving)/100);      %Reduced total energy consumption through Eco_Driving(in %) in kwh
        vehicle.Input.eco_driving = Parameters.software.values.power.eco_driving;
    end
    %---------------------------------------------------%
